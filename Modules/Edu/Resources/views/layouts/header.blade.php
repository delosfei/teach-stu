        ...
        <nav class="navbar navbar-expand-sm navbar-light bg-light pt-3 pb-3 pl-md-0 pr-md-0 align-items-center">
            ...
            <div id="collapsibleNavId" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0 font-weight-bold">
                    ...
                    <li class="nav-item pr-1">
                        <a href="https://www.houdunren.com/Edu/live" class="nav-link">直播间</a>
                    </li>
                </ul>
                ...
                <div class="form-inline my-2 my-lg-0">
                    <div class="nav-item pr-2 dropdown">
                        ...
                        <div aria-labelledby="dropdownId" class="dropdown-menu">
                            ...
                            <a href="https://www.houdunren.com/edu/member/topic?17601" class="dropdown-item mb-2">我的贴子</a>
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="https://www.houdunren.com/edu/space/17601/topic" class="dropdown-item mb-2">我的主页</a>
                            <div class="dropdown-divider"></div>
                            <a href="https://www.houdunren.com/auth/logout" class="dropdown-item mb-2">退出登录</a>
                        </div>
                    </div>
                </div>
