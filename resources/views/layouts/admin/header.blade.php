<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item mr-3">
                <a class="nav-link" href="{{ route('admin.module.index') }}"> <i class="fa fa-cubes"
                                                                                 aria-hidden="true"></i> 模块管理</a>
            </li>
            <li class="nav-item mr-3">
                <a class="nav-link" href="{{ route('admin.config.edit') }}"> <i class="fa fa-comments-o"
                                                                                aria-hidden="true"></i> 系统设置</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.group.index') }}"> <i class="fa fa-users"
                                                                                aria-hidden="true"></i> 会员组</a>
            </li>
