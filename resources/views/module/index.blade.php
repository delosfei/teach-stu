        ...
        <div class="card-body">
            @foreach($modules as $module)
                <section class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                    ...
                    <img
                        src="/modules/{{$module['name']}}/static/preview.jpg"
                        alt="" style="width:45px;" class="rounded-circle mr-3">
                    <div class="flex-fill">
                    ...
                    <div class="mr-3">
                        ...
                        @else
                            <a href="{{route('admin.module.install',$module['name'])}}"
                               class="btn btn-info btn-sm">安装</a>
                        @endif
                    </div>
                </section>
            @endforeach
